export const data = [
  ...
  },
  {
    ...
    title: "Çinçin",
    desc:
      "Çinçin (Ankara) It is said that the police cannot enter easily. During the large-scale raids, kilos of drugs and small ammunition were found in the houses. Famous for its events, it is said that field battles were fought on its hills. Not only at night, but also during the day, it is famous as a place that should not be entered if possible.",
    image:
      "https://i4.hurimg.com/i/hurriyet/75/866x494/5926ddbb18c7741478fc6204.jpg",
  },
  {
    id: 7,
    title: "Venice",
